...
var leverageStr = process.env.TRADE_LEVERAGE;
var TRADE_LEVERAGE = Number(leverageStr);
if (isNaN(TRADE_LEVERAGE)) {
    throw new Error("TRADE_LEVERAGE must be a valid number");
}
var txExecutor = new executor.ContangoTxExecutor(TRADE_LEVERAGE, process.env.EXECUTOR_ADDRESS, process.env.EXECUTOR_PRIV_KEY, utils.MAESTRO_CONTRACT, utils.LENS_CONTRACT, utils.VAULT_CONTRACT, 1);
